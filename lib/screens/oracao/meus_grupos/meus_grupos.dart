...
class MeusGrupos extends StatefulWidget {
  @override
  _MeusGruposState createState() => _MeusGruposState();
}
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: <Widget>[
            ...
            Text("Meus Grupos", style: TextStyle(color: COR_CTA, fontSize: 17, fontFamily: "Gibson"),),
          ],
        ),
        actions: <Widget>[
          IconButton(icon: Icon(Icons.share), onPressed: (){
            Share.share("Vamos orar pelos nossos grupos?\n\n$mensagem");
          })
        ],
      ),
      body: Column(
