...
class MinhaIgreja extends StatefulWidget {
  @override
  _MinhaIgrejaState createState() => _MinhaIgrejaState();
}

class _MinhaIgrejaState extends State<MinhaIgreja> {
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: <Widget>[
            ...
            Text("Minha Igreja", style: TextStyle(color: COR_CTA, fontSize: 17, fontFamily: "Gibson"),),
          ],
        ),
        actions: <Widget>[
          IconButton(icon: Icon(Icons.share), onPressed: (){
            Share.share("Vamos orar pela nossa igreja?\n\n$mensagem");
          })
        ],
      ),
      body: Column(
